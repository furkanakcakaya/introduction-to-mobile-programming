...
public class PlaylistsWithSongs {
        @Embedded
        public RPlaylist rPlaylist;

        @Relation(parentColumn = "playlistId", entityColumn = "songId", associateBy = @Junction(SongPlaylistCrossRef.class))
        public List<RSong> rSongs;
    }
